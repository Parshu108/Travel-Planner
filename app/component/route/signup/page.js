...
const destinations = [
  { place: "Kyoto", note: "7-day trip · temples + food" },
  { place: "Lisbon", note: "5-day trip · coast + culture" },
  { place: "Reykjavik", note: "4-day trip · northern lights" },
  { place: "Marrakech", note: "6-day trip · markets + desert" },
];
...
export default function Signup() {
  ...
  // Rotate the "recently planned" card
  useEffect(() => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      router.push("/component/route/login");
    } catch (err) {
        ...
        <div className="relative flex h-full flex-col justify-between p-12">
          ...
          <div className="max-w-sm">
            ...
            <p className="mt-3 text-sm text-sand-50/80">
              Day-by-day itineraries, built around your budget and your pace —
              generated in seconds, editable in one tap.
            </p>
          </div>

          <div
            key={index}
            className="rounded-xl border border-sand-50/20 bg-sand-900/40 p-4 backdrop-blur-sm"
          >
        ...
        <div className="w-full max-w-sm">
          ...
          <div className="mb-8">
            ...
            <p className="mt-2 text-sm leading-relaxed text-sand-900/60">
              Create an account to save trips and let the AI remember your
              travel style.
            </p>
          </div>
          ...
          <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
            ...
            <div className="grid gap-1.5">
              <Label htmlFor="name" className="text-xs font-medium text-sand-900/80">
                Full name
              </Label>
              <div className="relative">
                <User className="pointer-events-none absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 text-sand-900/35" />
                <Input
                  id="name"
                  name="name"
                  type="text"
            ...
            <div className="grid gap-1.5">
              <Label htmlFor="email" className="text-xs font-medium text-sand-900/80">
                Email
              </Label>
              <div className="relative">
            ...
            <div className="grid gap-1.5">
              <Label htmlFor="password" className="text-xs font-medium text-sand-900/80">
                Password
              </Label>
              <div className="relative">
            ...
            <Button
              type="submit"
              disabled={loading}
              className="mt-2 h-10 w-full border bg-sand-500 font-medium text-sand-50 hover:bg-sand-900"
            >
            ...
            >
              <svg className="mr-2 h-4 w-4" viewBox="0 0 24 24" aria-hidden="true">
                ...
                <path fill="#EA4335" d="M12 4.75c1.76 0 3.34.6 4.59 1.79l3.44-3.44C17.95 1.19 15.24 0 12 0A12 12 0 0 0 1.28 6.61l3.99 3.11C6.22 6.86 8.87 4.75 12 4.75Z" />
              </svg>
